...
module.exports = function (eleventyConfig) {
    ...
    eleventyConfig.addPassthroughCopy("./src/pdf"); // All files is "src/pdf" are copied as such in "public/pdf"
    eleventyConfig.addPassthroughCopy("./src/slides"); // All files is "src/pdf" are copied as such in "public/pdf"
